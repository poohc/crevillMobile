(function(factory){'use strict';if(typeof define==='function'&&define.amd){define(['jquery'],factory)}else if(typeof exports!=='undefined'){module.exports=factory(require('jquery'))}else{factory(jQuery)}}(function($){'use strict';var EvoCalendar=window.EvoCalendar||{};EvoCalendar=(function(){var instanceUid=0;function EvoCalendar(element,settings){var _=this;_.defaults={theme:null,format:'mm/dd/yyyy',titleFormat:'MM yyyy',eventHeaderFormat:'MM d, yyyy',firstDayOfWeek:'Sun',language:'en',todayHighlight:!1,sidebarDisplayDefault:!0,sidebarToggler:!0,eventDisplayDefault:!0,eventListToggler:!0,calendarEvents:null};_.initials={default_class:$(element)[0].classList.value,validParts:/dd?|DD?|mm?|MM?|yy(?:yy)?/g,dates:{en:{days:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],daysShort:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],daysMin:["Su","Mo","Tu","We","Th","Fr","Sa"],months:["January","February","March","April","May","June","July","August","September","October","November","December"],monthsShort:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"]},es:{days:["Domingo","Lunes","Martes","Miércoles","Jueves","Viernes","Sábado"],daysShort:["Dom","Lun","Mar","Mié","Jue","Vie","Sáb"],daysMin:["Do","Lu","Ma","Mi","Ju","Vi","Sa"],months:["Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre"],monthsShort:["Ene","Feb","Mar","Abr","May","Jun","Jul","Ago","Sep","Oct","Nov","Dic"]},de:{days:["Sonntag","Montag","Dienstag","Mittwoch","Donnerstag","Freitag","Samstag"],daysShort:["So","Mo","Di","Mi","Do","Fr","Sa"],daysMin:["So","Mo","Di","Mi","Do","Fr","Sa"],months:["Januar","Februar","März","April","Mai","Juni","Juli","August","September","Oktober","November","Dezember"],monthsShort:["Jan","Feb","Mär","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"]}}}
_.options=$.extend({},_.defaults,settings);if(_.options.calendarEvents!=null){for(var i=0;i<_.options.calendarEvents.length;i++){if(!_.options.calendarEvents[i].id){console.log("%c Event named: \""+_.options.calendarEvents[i].name+"\" doesn't have a unique ID ","color:white;font-weight:bold;background-color:#e21d1d;")}
...
return date.join('')};EvoCalendar.prototype.setTheme=function(themeName){var _=this;var prevTheme=_.options.theme;_.options.theme=themeName.toLowerCase().split(' ').join('-');if(_.options.theme)$(_.$elements.calendarEl).removeClass(prevTheme);if(_.options.theme!=='default')$(_.$elements.calendarEl).addClass(_.options.theme)}
...
EvoCalendar.prototype.initEventListener=function(){var _=this;$(window).on('resize.evocalendar.evo-'+_.instanceUid,$.proxy(_.resize,_));if(_.options.sidebarToggler){_.$elements.sidebarToggler.off('click.evocalendar').on('click.evocalendar',_.toggleSidebar)}
...
_.$elements.sidebarEl.find('[data-month-val]').off('click.evocalendar');_.$elements.sidebarEl.find('[data-year-val]').off('click.evocalendar');_.$elements.eventEl.find('[data-event-index]').off('click.evocalendar')};EvoCalendar.prototype.calculateDays=function(){var _=this,nameDays,firstDayOfWeekName,firstDay;_.monthLength=_.$label.days_in_month[_.$active.month];if(_.$active.month==1){if((_.$active.year%4==0&&_.$active.year%100!=0)||_.$active.year%400==0){_.monthLength=29}}
nameDays=_.initials.dates[_.options.language].daysShort;firstDayOfWeekName=nameDays.map(function(obj){return obj}).indexOf(_.options.firstDayOfWeek);if(firstDayOfWeekName<0){firstDayOfWeekName=_.initials.dates[_.defaults.language].daysShort.map(function(obj){return obj}).indexOf(_.defaults.firstDayOfWeek)}
while(_.$label.days.length<nameDays.length){if(firstDayOfWeekName==nameDays.length){firstDayOfWeekName=0}
_.$label.days.push(nameDays[firstDayOfWeekName]);firstDayOfWeekName++}
firstDay=new Date(_.$active.year,_.$active.month).getDay()-firstDayOfWeekName;_.startingDay=firstDay<0?(_.$label.days.length+firstDay):firstDay}
...
markup+='</ul>';markup+='</div></div>';markup+='<div class="calendar-inner">'+'<table class="calendar-table">'+'<tr><th colspan="7"></th></tr>'+'<tr class="calendar-header">';for(var i=0;i<=6;i++){markup+='<td class="calendar-header-day">'+_.$label.days[i]+'</td>'}
...
EvoCalendar.prototype.buildCalendar=function(){var _=this,markup,title;_.calculateDays();title=_.formatDate(new Date(_.$label.months[_.$active.month]+' 1 '+_.$active.year),_.options.titleFormat,_.options.language);_.$elements.innerEl.find('.calendar-table th').text(title);_.$elements.innerEl.find('.calendar-body').remove();markup+='<tr class="calendar-body">';var day=1;for(var i=0;i<9;i++){for(var j=0;j<=6;j++){markup+='<td class="calendar-day">';if(day<=_.monthLength&&(i>0||j>=_.startingDay)){var thisDay=_.formatDate(_.$label.months[_.$active.month]+' '+day+' '+_.$active.year,_.options.format);markup+='<div class="day" role="button" data-date-val="'+thisDay+'">'+day+'</div>';day++}
markup+='</td>'}
...
if(_.options.calendarEvents!=null){_.buildEventIndicator()}};EvoCalendar.prototype.addEventIndicator=function(active_date,type){var _=this,htmlToAppend,thisDate=_.$elements.innerEl.find('[data-date-val="'+active_date+'"]');if(thisDate.find('span.event-indicator').length===0){thisDate.append('<span class="event-indicator"></span>')}
if(thisDate.find('span.event-indicator > .type-bullet > .type-'+type).length===0){htmlToAppend='<div class="type-bullet"><div class="type-'+type+'"></div></div>';thisDate.find('.event-indicator').append(htmlToAppend)}}
EvoCalendar.prototype.removeEventIndicator=function(active_date,type){var _=this;var eventLength=0;if(_.$elements.innerEl.find('[data-date-val="'+active_date+'"] span.event-indicator').length===0){return}
for(var i=0;i<_.options.calendarEvents.length;i++){if(active_date===_.options.calendarEvents[i].date&&type===_.options.calendarEvents[i].type){eventLength++}}
if(eventLength===0){_.$elements.innerEl.find('[data-date-val="'+active_date+'"] span.event-indicator > .type-bullet > .type-'+type).parent().remove()}}
EvoCalendar.prototype.buildEventIndicator=function(){var _=this;_.$elements.innerEl.find('.calendar-day > day > .event-indicator').empty();for(var i=0;i<_.options.calendarEvents.length;i++){for(var x=0;x<_.monthLength;x++){var active_date=_.formatDate(_.$label.months[_.$active.month]+' '+(x+1)+' '+_.$active.year,_.options.format);if(active_date==_.options.calendarEvents[i].date){_.addEventIndicator(active_date,_.options.calendarEvents[i].type)}
else if(_.options.calendarEvents[i].everyYear){var d=_.formatDate(active_date,'mm/dd');var dd=_.formatDate(_.options.calendarEvents[i].date,'mm/dd');if(d==dd){_.addEventIndicator(active_date,_.options.calendarEvents[i].type)}}}}};EvoCalendar.prototype.selectEvent=function(event){var _=this;var el=$(event.target).closest('.event-container');var id=$(el).data('eventIndex');var index=_.options.calendarEvents.map(function(event){return event.id}).indexOf(id);$(_.$elements.calendarEl).trigger("selectEvent",[_.options.calendarEvents[index]])}
...
_.buildSidebarMonths();_.buildCalendar()};EvoCalendar.prototype.selectDate=function(event){var _=this;var oldDate=_.$active.date;var date,year,month,activeDayEl,isSameDate;if(typeof event==='string'||typeof event==='number'||event instanceof Date){date=_.formatDate(new Date(event),_.options.format)
...
if(windowW<=_.$breakpoints.tablet){hasEvent=!_.$elements.calendarEl.hasClass('event-hide');hasSidebar=!_.$elements.calendarEl.hasClass('sidebar-hide');if(hasEvent&&hasSidebar)_.toggleSidebar()}};EvoCalendar.prototype.addCalendarEvent=function(arr){var _=this;function addEvent(data){if(!data.id){console.log("%c Event named: \""+data.name+"\" doesn't have a unique ID ","color:white;font-weight:bold;background-color:#e21d1d;")}
if(_.isValidDate(data.date)){data.date=_.formatDate(new Date(data.date),_.options.format);if(!_.options.calendarEvents)_.options.calendarEvents=[];_.options.calendarEvents.push(data);_.addEventIndicator(data.date,data.type);if(_.$active.event_date===data.date)_.addEventList(data);_.$elements.innerEl.find("[data-date-val='"+data.date+"']")}else{console.log("%c Event named: \""+data.name+"\" has invalid date ","color:white;font-weight:bold;background-color:#e21d1d;")}}
if(arr instanceof Array){for(var i=0;i<arr.length;i++){addEvent(arr[i])}}else if(typeof arr==='object'){addEvent(arr)}};EvoCalendar.prototype.removeCalendarEvent=function(arr){var _=this;function deleteEvent(data){var index=_.options.calendarEvents.map(function(event){return event.id}).indexOf(data);if(index>=0){var active_date=_.options.calendarEvents[index].date;var type=_.options.calendarEvents[index].type;_.options.calendarEvents.splice(index,1);_.removeEventList(data);_.removeEventIndicator(active_date,type)}else{console.log("%c "+data+": ID not found ","color:white;font-weight:bold;background-color:#e21d1d;")}}
