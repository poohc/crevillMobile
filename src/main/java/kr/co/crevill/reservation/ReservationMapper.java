...
public interface ReservationMapper {
	...
	public int checkAlreadySameTimeReservation(ReservationDto reservationDto);
	...
	public ReservationVo getScheduleTimeAndVoucherTime(ReservationDto reservationDto);
